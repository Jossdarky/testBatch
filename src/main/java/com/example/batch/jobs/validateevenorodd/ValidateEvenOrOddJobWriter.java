...
@Component
public class ValidateEvenOrOddJobWriter implements ItemWriter<DatoDTO> {

    private static final String OUTPUT_FILE = "./csv/ARCHIVO-SALIDA.csv";

    @Autowired
    ValidateEvenOrOddJobProcessor validateEvenOrOddJobProcessor;
    ...
    public void write(List<? extends DatoDTO> items) throws Exception {
        ...
        List<CSVRowDTO> recordsWithErrors = validateEvenOrOddJobProcessor.getRecordsWithErrors();
